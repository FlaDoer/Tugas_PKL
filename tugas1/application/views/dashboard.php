...
<head>
    ...
    <meta charset="utf-8" />
    <title>Preloader | Skote - Admin & Dashboard Template</title>
...
<body data-sidebar="dark">
                ...
                <div class="d-flex">
                    ...
                    <div class="dropdown d-inline-block">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <a class="dropdown-item text-danger" href="<?= site_url('login/logout'); ?>"><i
    ...
    <?= isset($js) ? '<script src="' . base_url() . 'assets/js/' . $js . '"></script>' : ''; ?>
</body>
